    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.CharField(choices=[('hero-product', 'Hero Product'), ('featured-product', 'Featured Product'), ('normal', 'Normal Product')], default='normal', max_length=20)),
                ...
                ('serve', models.CharField(blank=True, max_length=100)),
